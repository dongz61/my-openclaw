  ...
  try {
    ...
    const toolsRaw = params.disableTools
      ...
      : createOpenClawCodingTools({
          ...
          ...(params.toolPolicyOverride ? { toolPolicyOverride: params.toolPolicyOverride } : {}),
    ...
    const systemPromptTextForRun = params.systemPromptOverride?.trim();
    const appendPrompt =
      systemPromptTextForRun ||
      buildEmbeddedSystemPrompt({
        workspaceDir: effectiveWorkspace,
